...
{
    /// <summary>
    /// [UNITY] Designer-tunable asteroid gem burst. Create via
    /// Assets → Create → Titan Orbit → Gem Explosion Settings (default path
    ...
    /// with Min/Max gem count editable in 1–10 for testing denser bursts.
    /// </summary>
    [CreateAssetMenu(
    ...
    public class GemExplosionSettings : ScriptableObject
    {
        ...
        [Tooltip("Maximum gems spawned when an asteroid is destroyed (clamped by remaining value). Original NGO used 1–3; raise to 10 to test denser bursts.")]
        [Range(1, 10)]
