    ...
    public static class ShipComponentStoreData
    {
        ...
        public static ShipComponentAbilityStats GetEffectiveStatsAtShipLevel(ShipComponentAbilityStats stats, int shipLevel)
        {
            ...
            return new ShipComponentAbilityStats
            {
                ...
                thrustEnergyDrain = stats.thrustEnergyDrain + stats.thrustEnergyDrainPerLevel * perLvl,
                thrustEnergyDrainPerLevel = stats.thrustEnergyDrainPerLevel,
                extraSpeedPercent = stats.extraSpeedPercent + stats.extraSpeedPercentPerLevel * perLvl,
                extraSpeedPercentPerLevel = stats.extraSpeedPercentPerLevel,
                extraSpeedEnergyPercent = stats.extraSpeedEnergyPercent + stats.extraSpeedEnergyPercentPerLevel * perLvl,
