...
{
    /// <summary>
    /// Ramming vs asteroids: restitution (bounce) scales down with ramming power and effective hull mass —
    /// heavy ships stick and slide; light ships rebound. Continuous push into the surface chips the rock (grind).
    /// Prefer <c>TitanOrbit.Data.ShipComponentRammingSuggestions</c> from ECS / HUD (keeps formulas in one place).
    /// </summary>
    public static class AsteroidRammingBehavior
    {
        ...
        /// Mirrored in <c>ShipComponentRammingSuggestions.ComputeNormalPushNewtons</c> for ECS.
        /// </summary>
